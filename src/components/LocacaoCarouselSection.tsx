...
/* cor de fundo da seção — usada também nos fades das bordas */
const BG = "#0e3070";
...
const LocacaoCarouselSection = () => {
  ...
  return (
    <section className="relative z-10">
      ...
      >
        {/* Orbs */}
        <div className="absolute top-0 right-0 w-80 h-80 rounded-full pointer-events-none animate-float-orb"
          style={{ background: "radial-gradient(circle, rgba(91,200,239,0.22) 0%, transparent 65%)", filter: "blur(90px)" }} />
        <div className="absolute bottom-0 left-10 w-56 h-56 rounded-full pointer-events-none animate-float-orb animation-delay-2000"
          style={{ background: "radial-gradient(circle, rgba(32,114,185,0.18) 0%, transparent 65%)", filter: "blur(70px)" }} />

        {/* Header */}
        <div className="container mx-auto px-4 relative z-10 mb-8">
          <span className="text-xs uppercase tracking-[3px] block text-center mb-4" style={{ ...ms6, color: "#7ec8ef" }}>
            Locação de radiocomunicadores
          </span>
          <h2 className="text-3xl md:text-4xl text-center text-white mb-4" style={ms}>
            Rádios na sua mão.{" "}
            <span style={{ backgroundImage: "linear-gradient(90deg, #5bc8ef, #a8e0f8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
        ...
        <div className="relative overflow-hidden cursor-grab active:cursor-grabbing" ref={containerRef}>
          {/* fades nas bordas — usa a cor exata do fundo */}
          <div className="absolute left-0 top-0 bottom-0 w-44 z-10 pointer-events-none"
            style={{ background: `linear-gradient(to right, ${BG}, transparent)` }} />
          <div className="absolute right-0 top-0 bottom-0 w-44 z-10 pointer-events-none"
          ...
          >
            {locacaoRadios.map((radio) => (
              ...
              >
                ...
                <div className="bg-white p-5 flex items-center justify-center h-[200px]" style={{ background: "#f5f9ff" }}>
                  <img
                    src={radio.img}
                    alt={radio.name}
                ...
                {/* Info — fundo branco, texto escuro */}
          ...
          {!dragged && (
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 text-xs animate-pulse z-20"
