    ...
    <section className="bg-background py-20">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="mt-4 text-muted-foreground text-lg leading-relaxed" style={{ ...ms, fontWeight: 400 }}>
          ...
          {painPoints.map((p, i) => (
            <GlowCard key={i} intensity="medium" className="p-6 space-y-4">
              <div
                ...
                style={{ background: "rgba(31,156,216,0.10)" }}
              >
                <p.icon className="w-6 h-6" style={{ color: "#1F9CD8" }} />
              </div>
              <h3 className="text-base leading-snug text-foreground" style={ms}>
                {p.title}
              </h3>
              <p className="text-sm text-muted-foreground leading-relaxed" style={{ ...ms, fontWeight: 400 }}>
                {p.desc}
              </p>
            </GlowCard>
          ))}
